...
const base = {
    ...
    total:"/api/total",
    //商品总条数
    categoryUrl:"/api/backend/itemCategory/selectItemCategoryByParentId",
    //商品选择类目地址
    productAdd:"/api/backend/item/insertTbItem",
    ...
    paramsList:"/api/backend/itemParam/selectItemParamAll",//规格参数
