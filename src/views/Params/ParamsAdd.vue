<template>
        <el-dialog
            ...
            <!-- 内层dialog -->
                <el-dialog width="60%" title="规格参数" :visible.sync="innerParamsAddVisible" append-to-body>
                    ...
                    <span slot="footer" class="dialog-footer">
                        ...
                        <el-button type="primary" @click="paramsSubmit">提 交</el-button>
                    </span>
                </el-dialog>
            <!-- 内层dialog -->
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button :disabled="disabled" type="primary" @click="paramsContentHandle">确定添加分组内容</el-button>
            </span>
        </el-dialog>
</template>
